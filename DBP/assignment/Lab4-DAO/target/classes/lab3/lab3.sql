DROP TABLE DEPT0989 CASCADE CONSTRAINTS;
DROP TABLE EMP0989 CASCADE CONSTRAINTS;

CREATE TABLE DEPT0989 (
	DEPTNO NUMBER(2) PRIMARY KEY,
	DNAME VARCHAR2(14),
	LOC VARCHAR2(13),
	MANAGER NUMBER(4) ) ;

CREATE TABLE EMP0989 (
	...
	SAL NUMBER(7,2),
	COMM NUMBER(7,2),
	DEPTNO NUMBER(2) REFERENCES DEPT0989(DEPTNO));

INSERT INTO DEPT0989 VALUES
...
ALTER TABLE DEPT0989 ADD CONSTRAINT FK_DEPT0989 FOREIGN KEY(MANAGER) REFERENCES EMP0989(EMPNO);
